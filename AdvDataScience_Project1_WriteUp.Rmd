...
any of these .R files matched "run_analysis.r" by using the *to.lower* function in R to allow for various capitalizated letters and 
still match.
Fianlly, we scraped the "run_analysis.R" file using the *readlines* function on the approraite url based on the file name, repository name 
and branch name.
